...
import "../../ConfirmMeasurement/PDFConfirmMeasure/PDFConfirmMeasure.css";
      ...
      <div className="flex justify-between dataDetailReportMeasurements-center">
        <div className="text-center mb-5">
          <ReactToPrint
            ...
            documentTitle={`N/A-Measurement-${dataDetailReportMeasurement?.id}`}
                ...
                <table className="w-full border-collapse mt-5">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="text-center p-[3px] text-[10px]">N/A</td>
...
export default PDFUnconfirmMeasure;
