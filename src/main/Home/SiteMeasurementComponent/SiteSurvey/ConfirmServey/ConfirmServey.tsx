      ...
      >
        <table className="w-full text-sm text-left border border-gray-200">
          ...
          <tbody>
            ...
            {!isLoading && AllReportSurveyConfirm?.length === 0 && (
              <tr>
                <td
                  colSpan={headerNew.length + 2}
            ...
            {AllReportSurveyConfirm?.map((item: any, index: number) => {
              const isLastItem = index === AllReportSurveyConfirm.length - 1;
              return (
                <tr
                  key={index}
